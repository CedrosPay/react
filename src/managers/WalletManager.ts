...
export class WalletManager implements IWalletManager {
  ...
  async buildTransaction(
    ...
    console.log('🔨 [WalletManager] Building NEW transaction for resource:', requirement.resource);
  ...
  async signTransaction(
    ...
    console.log('✅ [WalletManager] Transaction signed with signature:', signature.substring(0, 20) + '...');
  ...
  async partiallySignTransaction(
    ...
    if (firstSignature) {
      ...
      console.log('✅ [WalletManager] Partially signed with signature:', sig.substring(0, 20) + '...');
    }
