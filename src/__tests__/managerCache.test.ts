...
describe('ManagerCache', () => {
  ...
  describe('getOrCreateManagers', () => {
    it('creates new managers for first call', () => {
      const managers = getOrCreateManagers(
        'pk_test_123',
        'http://localhost:8080',
        'devnet'
      );
    ...
    it('reuses managers for identical config', () => {
      const managers1 = getOrCreateManagers(
        'pk_test_123',
        'http://localhost:8080',
        'devnet'
      );

      const managers2 = getOrCreateManagers(
        'pk_test_123',
        'http://localhost:8080',
        'devnet'
      );
    ...
    it('creates separate managers for different server URLs', () => {
      const managers1 = getOrCreateManagers(
        'pk_test_123',
        'http://localhost:8080',
        'devnet'
    ...
    it('creates separate managers for different Solana clusters', () => {
      const managers1 = getOrCreateManagers(
        'pk_test_123',
        'http://localhost:8080',
        'devnet'
    ...
    it('creates separate managers for different Solana endpoints', () => {
      const managers1 = getOrCreateManagers(
        'pk_test_123',
        'http://localhost:8080',
        'devnet',
    ...
    it('creates separate managers for different dangerouslyAllowUnknownMint flags', () => {
      const managers1 = getOrCreateManagers(
        'pk_test_123',
        'http://localhost:8080',
        'devnet',
    ...
    it('increments refCount for each call with same config', () => {
  ...
  describe('releaseManagers', () => {
    it('decrements refCount when releasing', () => {
      getOrCreateManagers('pk_test_123', 'http://localhost:8080', 'devnet');
      getOrCreateManagers('pk_test_123', 'http://localhost:8080', 'devnet');
    ...
    it('removes managers from cache when refCount reaches 0', () => {
      getOrCreateManagers('pk_test_123', 'http://localhost:8080', 'devnet');
  ...
  describe('Multi-provider scenarios', () => {
    it('shares managers between two providers with same config', () => {
      // Provider 1 mounts
      const p1Managers = getOrCreateManagers('pk_test_123', 'http://localhost:8080', 'devnet');

      // Provider 2 mounts with same config
      const p2Managers = getOrCreateManagers('pk_test_123', 'http://localhost:8080', 'devnet');
    ...
    it('isolates managers between providers with different configs', () => {
      // Provider 1: Tenant A
      const tenantA = getOrCreateManagers('pk_test_123', 'http://localhost:8080', 'devnet');

      // Provider 2: Tenant B (different Stripe key)
      const tenantB = getOrCreateManagers('pk_test_456', 'http://localhost:8080', 'devnet');
    ...
    it('handles nested providers correctly', () => {
      // Outer provider
      const outer = getOrCreateManagers('pk_test_123', 'http://localhost:8080', 'devnet');

      // Inner provider (different server)
      const inner = getOrCreateManagers('pk_test_123', 'http://localhost:8081', 'devnet');
  ...
  describe('clearManagerCache', () => {
    it('clears all cached managers', () => {
      getOrCreateManagers('pk_test_123', 'http://localhost:8080', 'devnet');
      getOrCreateManagers('pk_test_456', 'http://localhost:8081', 'mainnet-beta');
  ...
  describe('Memory optimization scenarios', () => {
    it('prevents duplicate Stripe.js loads for same public key', () => {
      // Scenario: Multiple dashboards for different users, same Stripe account
      const dashboard1 = getOrCreateManagers('pk_test_123', 'http://localhost:8080', 'devnet');
      const dashboard2 = getOrCreateManagers('pk_test_123', 'http://localhost:8080', 'devnet');
      const dashboard3 = getOrCreateManagers('pk_test_123', 'http://localhost:8080', 'devnet');
    ...
    it('allows separate managers for multi-tenant SaaS', () => {
      // Scenario: Multi-tenant SaaS, each tenant has their own Stripe account
      const tenant1 = getOrCreateManagers('pk_test_tenant1', 'http://localhost:8080', 'devnet');
      const tenant2 = getOrCreateManagers('pk_test_tenant2', 'http://localhost:8080', 'devnet');
      const tenant3 = getOrCreateManagers('pk_test_tenant3', 'http://localhost:8080', 'devnet');
